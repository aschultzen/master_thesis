...
\subsection{Issues during testing}
blabla
	
\subsection{Generating MJD}
Modified Julian Day (MJD) is a way to express both date and time as a single number. It's convenient because the difference between the MJD for one day and the next, is exactly 1\footnote{For example, the MJD for 24/10-2016 00:00 is 57685.0 and the MJD for 25/10-2016 00:00
is 57685.0. 12'o clock at the 25/10 would be 57658.5}. 

\subsection{Sigchild handler}
Write about how that went down
