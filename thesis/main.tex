...
\end{table}
In this document, the word \textit{telemetry} gets mentioned quite often. The telemetry received from the SA.45 contains a plethora of information like:
...
\begin{itemize}
  ...
  \item The client is marked as ready for processing and a ready check is commenced. The ready check is used to make sure that all the sensors have received NMEA data and are ready to have filters applied. 
