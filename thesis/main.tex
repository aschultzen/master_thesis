...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Path to GNSS receiver is set to \texttt{/dev/ttyACM0} which should be the path to the receiver unless another similar address is connected to the computer given it is a Raspberry Pi running Raspbian.
  \end{itemize}
