...
OK!
\end{lstlisting}
One can write scripts that interface with Sensor Server by using an implementation of Sockets. An example of such a script can be found in the appendix (\ref{script_example}).
