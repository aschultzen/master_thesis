...
\begin{itemize}
	\item Describing the clock model algorithm as seen under chapter \ref{clock_model_harald}.
	...
	\item Calculating the preliminary filter reference values, both for clock model based filters and GPS based filters. These were based on analysis of data gathered as described under subsection \ref{data_aquisition}. Optimal choice of filter parameters is considered to be outside of the scope of this work.
\end{itemize}
...
\section{Logger setup schematic}\label{CLS}
	 \includegraphics[scale=0.5]{csac_logger_g.pdf}
...
\chapter{Figures}
	\begin{figure}
	\centering
	  \includegraphics[scale=0.09]{lab_setup_g.jpg}
