...
\subsection{Our Proposal: Spoof proof CSAC SMACC}\label{op}
\begin{wrapfigure}{c}{0.45\textwidth}
  \centering
...
\subsubsection{Choice of chip scale atomic clock}
...
\subsubsection{Choice of SMACC platform}
