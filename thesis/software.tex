...
Listing \ref{telemetry_string} show an example of telemetry received from the atomic clock. The fourth value from the right, is the \texttt{DiscOK}, the fifth is the \texttt{phase} and the \texttt{steer} is the seventh. 
