...
\subsection{Signal-level Spoofing}\label{sls}
...
\subsection{Data-level Spoofing}\label{dls}
...
\subsection{Replay spoofing}\label{rs}
...
\subsection{Malfunctions}\label{mf}
...
\subsection{Monitoring Signal Power} %[C1]
...
\subsection{Checking solved position against known position} %[C7]
...
\subsection{Checking time solutions against receiver clock statistics} %[C8]
...
%Need some more meat about why time is important anyway.

\subsection{Cross-checking navigation data among receivers} %[C5]
