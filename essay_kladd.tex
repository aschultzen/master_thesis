...
\section{Clocks}
What does a \$10 wristwatch and a \$100 000 atomic clock have in common? They both drift. This phenomena known as \textit{clock drift}, is when a clock no longer runs at the exact same speed as a reference clock and they drift apart. This property is a result of how they "obtain" their time. A typical \$10 wristwatch uses a quartz-movement to keep the time.   Of course in our scenario with the wristwatch and the atomic clock, the similarities stop here. An atomic clock is a completely different beast from a wristwatch. 
\cite{CSMG}
