...
\begin{table}[h]
  ...
  \multicolumn{5}{c|}{Threat Models} \\ \cline{2-6} 
    ...
    \hline
    Monitoring Signal Power      (\ref{msp})        & N & X & X & X & N \\ \hline
    Check pos. solution          (\ref{cspakp})     & N & Y & Y & Y & Y \\ \hline
    Check time solutions         (\ref{ctsarcs})    & N & X & X & X & X \\ \hline
    Checking nav. data           (\ref{ccndar})     & X & N & Y & N & Y \\ \hline
    Reverse calculated sat. pos. (\ref{cndrcsp})    & N & X & X & Y & Y \\ \hline
    Cross-correlating P(Y)       (\ref{ccpc})       & N & Y & Y & N & N \\ \hline
    PIA TL                       (\ref{ptl})        & Y & N & N & Y & N \\ \hline
    Multi-receiver TL            (\ref{mrtl})       & Y & X & X & X & X \\ \hline
  \end{tabular}
