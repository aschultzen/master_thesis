...
\section{Clocks}
What does a \$10 wristwatch and a \$100000 atomic clock have in common? They both drift. This phenomena known as \texttt{clock drift}, is when a clock no longer runs at the exact same speed as a reference clock and they drift apart. Of course in our scenario with the wristwatch and the atomic clock, the wristwatch will drift faster. 
