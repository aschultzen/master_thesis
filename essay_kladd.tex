...
\subsubsection{PIA Tracking loops}\label{ptl} %[C3]
...
\hline
\multicolumn{1}{|c|}{\multirow{2}{*}{Counter Measures}} & \multicolumn{5}{c|}{Threat Models} \\ \cline{2-6} 
\multicolumn{1}{|c|}{} & \multicolumn{1}{l|}{\ref{jam} \newline Jamming} & \multicolumn{1}{r|}{\ref{dls} Data-level spoofing} & \multicolumn{1}{l|}{\ref{sls} Signal-level spoofing} & \multicolumn{1}{l|}{\ref{rs} Replay spoofing} & \multicolumn{1}{l|}{\ref{mf} Accidental receiver errors} \\ \hline
...
\ref{ccndar} Checking nav. data & X & Y & N & N & Y \\ \hline
