      ...
      \centering
        ...
        \label{gps_filter_table2}
          \resizebox{0.9\textwidth}{!}{\begin{tabular}{|l|l|l|}
            ...
            Altitude reference                 & 122.427$^{\circ}$             \\ \hline
            Longitude reference                & 1102.1934$^{\circ}$           \\ \hline
            Latitude reference                 & 5958.5231$^{\circ}$           \\ \hline
            Speed reference                    & 0 knot                        \\ \hline
            Altitude deviation                 & 10$^{\circ}$                  \\ \hline
            Longitude deviation                & 0.005$^{\circ}$               \\ \hline
            Latitude deviation                 & 0.005$^{\circ}$               \\ \hline
            Speed deviation                    & 1 knot                             \\ \hline
          \end{tabular}}
      \end{table}
