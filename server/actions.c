             ...
             int dump_human_read)
{
    ...
    if(dump_human_read) {
        ...
        */
        fprintf(h_dump,DUMPDATA_HEADER);
        inner_counter = 0;
        double *rdf = &client->fs.ls_f.lsf_d.alt_ref;
...
/*
* Load ls filter data into the client struct.
