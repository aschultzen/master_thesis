...
\end{figure}
As figure \ref{fig:freq_diff1} and \ref{fig:freq_diff2} shows, using an averaging technique when conducting measurements is obviously effective.
...
\begin{figure}[!htb]
  \caption{TIE 10MHz PHM 1 ms sample time Modified Allan Deviance.}
  \centering
