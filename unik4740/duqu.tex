...
The main DLL of Duqu (\texttt{netp192.pnf}) is responsible for loading the payload and removing the trace of Duqu after a given time. It contains the payload DLL (See appendix figure X) 
...
\begin{appendices}
  ...
  \chapter{Duqu architecture}
    \begin{figure}[hb]
      \centering
      \includegraphics[width=0.90\textwidth]{duqu_arc.eps}
      \caption[File system anatomy] {Diagram showing the architecture of Duqu once installed. \cite{DUQU_SYMANTEC}}\label{anatomy}
    \end{figure}
